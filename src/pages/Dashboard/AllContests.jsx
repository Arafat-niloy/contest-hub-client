    ...
    return (
        ...
        <div className="bg-white dark:bg-gray-900 min-h-screen pb-20 pt-24 font-sans text-[#1A1A1A] dark:text-gray-100 transition-colors duration-300">
            ...
            <div className="text-center mb-12">
                <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#1A1A1A] dark:text-white">Explore Contests</h2>
                <p className="text-gray-500 dark:text-gray-400 text-lg">Browse through categories and find your next challenge</p>
            </div>
            ...
            <div className="w-11/12 max-w-screen-2xl mx-auto min-h-[400px]">
                {contests.length > 0 ? (
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {contests.map(contest => (
                                ...
                                <div key={contest._id} className="card bg-white dark:bg-gray-800 shadow-lg hover:shadow-2xl border border-gray-100 dark:border-gray-700 hover:border-orange-100 dark:hover:border-gray-600 transition-all duration-300 rounded-2xl overflow-hidden group">
                    ...
                    <div className="flex flex-col items-center justify-center py-24 bg-gray-50 dark:bg-gray-800 rounded-3xl border border-dashed border-gray-300 dark:border-gray-700 transition-colors">
                        ...
                        <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-200">No Contests Found!</h3>
                        <p className="text-gray-500 dark:text-gray-400 mt-2">Try searching with a different keyword or category.</p>
